...
ActiveRecord::Schema.define(version: 2023_09_17_051057) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cafe_post_id"], name: "index_comments_on_cafe_post_id"
    t.index ["user_id"], name: "index_comments_on_user_id"
  end

  create_table "likes", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "cafe_post_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cafe_post_id"], name: "index_likes_on_cafe_post_id"
  ...
  add_foreign_key "comments", "cafe_posts"
  add_foreign_key "comments", "users"
  add_foreign_key "likes", "cafe_posts"
